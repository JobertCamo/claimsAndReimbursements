...
<div class="relative overflow-x-auto ">
    <div class="px-4 bg-white flex justify-between items-center">
        ...
        {{-- <h1 class="text-xs lg:text-xl font-bold">Rejected&nbsp;Claims</h1> --}}
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white hover:bg-gray-300">
                ...
                <td class="px-3 py-4">
                    {{ $claim->claim->amount_requested }}
                </td>
                <td class="px-3 py-4">
                    {{ $claim->claim->date }}
                </td>
                <td class="px-3 py-4">
                    <button class="bg-red-500 px-1 rounded-sm text-white">
                        {{ $claim->status }}
                    </button>
                </td>
